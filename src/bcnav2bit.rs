...
impl BCNav2Bit {
    ...
    pub fn get_frame_data(&self, start_time: GnssTime, svid: i32, _param: i32, nav_bits: &mut [i32]) -> i32 {
        ...
        self.compose_message(message_type, start_time.Week - 1356, sow, svid, &mut frame_data);
    ...
    fn compose_message(&self, message_type: i32, week: i32, sow: i32, svid: i32, frame_data: &mut [u32; 12]) {
    ...
    pub fn set_iono_utc(&mut self, _iono_param: Option<&IonoParam>, _utc_param: Option<&UtcParam>) -> i32 {
